        ...
        <Box sx={{ backgroundColor: '#f5f7fa', minHeight: '100vh', p: 6 }}>
            <Card sx={{ borderRadius: "15px", p: 4, boxShadow: '0 4px 20px rgba(0,0,0,0.05)', border: '1px solid #eef0f2', backgroundColor: '#fff' }}>
                                ...
                                {['ID', 'User', 'Type', 'Title', 'Date/Time', 'Status', 'Action'].map((head) => (
                                    <TableCell
                                        ...
                                        sx={{
                                            ...
                                            padding: '12px 16px', // Aapki exact padding
                        ...
                        <TableBody>
                            {disputes.map((row) => (
                                <TableRow key={row.id} hover>
                                    <TableCell align="left" sx={{ padding: '12px 16px', fontFamily: outfitFont, fontSize: '0.85rem', color: '#666' }}>
                                        {row.id}
                                    </TableCell>
                                    <TableCell align="left" sx={{ padding: '12px 16px', fontFamily: outfitFont, fontSize: '0.85rem', fontWeight: 500, color: '#111' }}>
                                        {row.user}
                                    </TableCell>
                                    <TableCell align="left" sx={{ padding: '12px 16px', fontFamily: outfitFont, fontSize: '0.85rem', color: '#444' }}>
                                        {row.type}
                                    </TableCell>
                                    <TableCell align="left" sx={{ padding: '12px 16px', fontFamily: outfitFont, fontSize: '0.85rem', color: '#666', maxWidth: '250px' }}>
                                        {row.title}
                                    </TableCell>
                                    <TableCell align="left" sx={{ padding: '12px 16px', fontFamily: outfitFont, fontSize: '0.85rem', color: '#666' }}>
                                        {row.date_time}
                                    </TableCell>
                                    <TableCell align="left" sx={{ padding: '12px 16px', fontFamily: outfitFont, fontSize: '0.85rem' }}>
                                        <Box sx={{ 
                                            textTransform: 'capitalize', 
                                            color: row.status === 'open' ? '#666' : '#4caf50',
                                            fontWeight: 600 
                                        }}>
                                            {row.status}
                                        </Box>
                                    ...
                                    <TableCell align="left" sx={{ padding: '12px 16px' }}>
                                        <IconButton size="small" sx={{ color: '#8e98a8', p: 0.5 }}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', mt: 4, gap: 1 }}>
                    <Button sx={{ bgcolor: '#9ee8eb', color: '#555', textTransform: 'none', borderRadius: '8px', height: 32, px: 2, fontFamily: outfitFont, fontWeight: 500, "&:hover": { bgcolor: '#86d2d5' }, boxShadow: 'none' }}>
                        Previous
                    </Button>
                    <Box sx={{ width: 32, height: 32, display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '6px', bgcolor: '#003b3d', color: '#fff', fontWeight: 600, fontFamily: outfitFont, fontSize: '0.9rem' }}>
                        1
                    </Box>
                    <Button variant="outlined" sx={{ textTransform: 'none', borderRadius: '8px', borderColor: '#ddd', color: '#666', height: 32, px: 2, fontFamily: outfitFont, fontWeight: 500 }}>
                        Next
                    </Button>
                </Box>
            </Card>
